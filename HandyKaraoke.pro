...
win32 {
    ...
    contains(QT_ARCH, i386) {
        ...
        LIBS += -L$$PWD/3rdParty/vlc-3.0.8-win32/sdk/lib/ -llibvlc -llibvlccore

        INCLUDEPATH += $$PWD/3rdParty/vlc-3.0.8-win32/sdk/include
        ...
        LIBS += -L$$PWD/3rdParty/vlc-3.0.8-win64/sdk/lib/ -llibvlc -llibvlccore

        INCLUDEPATH += $$PWD/3rdParty/vlc-3.0.8-win64/sdk/include
    }
